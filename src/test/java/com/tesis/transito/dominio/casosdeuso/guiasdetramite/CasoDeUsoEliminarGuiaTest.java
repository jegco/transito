...
class CasoDeUsoEliminarGuiaTest {

    @MockBean
    private GuiasDeTramiteDelegado delegado;

    private CasoDeUsoEliminarGuia casoDeUso;
    ...
    void setUp() {
        ...
        when(delegado.eliminar(guiaDeTramite)).thenReturn(Mono.empty());
        casoDeUso = new CasoDeUsoEliminarGuia(delegado);
    }
